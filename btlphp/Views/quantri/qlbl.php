...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
        ...
        <table class="table table-striped">
            <tr id="tbl-first-row">
              <td width="5%">#</td>
              <td width="10%">Tên xe</td>
              <td width="15%">Tên người bình luận</td>
          ...
          <?php
          while ($bl=$paginate->fetch_array()) {
              ?>
              <tr>
                <td><?php echo $bl['id_bl'];?></td>
                <td><?php echo $bl['name'];?></td>
                <td><?php echo $bl['ten_bl'];?></td>
                <td><?php echo $bl['dien_thoai'];?></td>
                <td><?php echo $bl['ngay_gio'];?></td>
                <td><?php echo $bl['binh_luan'];?></td>
                <td><a onclick="return confirm('Bạn có chắc chắn muốn xóa hay không?')" href="quantri.php?page_layout=delbl&id_bl=<?php echo $bl['id_bl']?>"><span><svg class="glyph stroked cancel" style="width: 20px;height: 20px;"><use xlink:href="#stroked-cancel"/></svg></span></a></td>
            </tr>
            <?php
        }
        ?>
