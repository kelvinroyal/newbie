...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Thêm xe mới</h1>
            </div>
        </div><!--/.row-->
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">Thêm xe mới</div>
                        ...
                        <form method="post" enctype="multipart/form-data" role="form">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cho_ngoi" required="">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="cong_suat" required="">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="nhien_lieu" required="">
                                </div>
                                <div class="form-group">
                                    <label>Lượng khí thải CO2</label>
                                    <input type="text" class="form-control" name="khi_thai" required="">
                                </div>
                                <div class="form-group">
                                    <label>Dài</label>
                                    <input type="text" class="form-control" name="dai" required="">
                                </div>
                                <div class="form-group">
                                    <label>Rộng</label>
                                    <input type="text" class="form-control" name="rong" required="">
                                </div>
                                <div class="form-group">
                                    <label>Cao</label>
                                    <input type="text" class="form-control" name="cao" required="">
                                </div>
                                <div class="form-group">
                                    <label>Thể tích bình xăng</label>
                                    <input type="text" class="form-control" name="the_tich" required="">
                                </div>

                                <div class="form-group">
                                    <label>Dòng xe</label>
                                    <select name="id_dong" class="form-control">
                                        <option value="unselect" selected>Lựa chọn dòng xe</option>
                                        <?php
                                        while ($dong=$paginate->fetch_array()) {
                                          ?>
                                          <option value="<?php echo $dong['id_dong'];?>"><?php echo $dong['name_dong'];?></option>
                                          <?php
                                      }
                                      ?>
                                  </select>
                          ...
                          <div class="col-md-12">
                           <label>Mô tả</label>
                           <textarea name="mo_ta" id="editor1" rows="10" class="col-md-12" required></textarea><br>
                       </div>
