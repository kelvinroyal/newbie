...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Quản lý dòng xe</h1>
            </div>
        </div><!--/.row-->
        ...
        <table class="table table-striped">
          ...
          while ($dong=$paginate->fetch_array()) {
              ?>
              <tr>
                <td><?php echo $dong['id_dong'];?></td>
                <td><?php echo $dong['name_dong'];?></td>
                <td><a href="quantri.php?page_layout=editdong&id_dong=<?php echo $dong['id_dong']?>"><span><svg class="glyph stroked brush" style="width: 20px;height: 20px;"><use xlink:href="#stroked-brush"/></svg></span></a></td>
                <td><a onclick="return confirm('Bạn có chắc chắn muốn xóa hay không?')" href="quantri.php?page_layout=deldong&id_dong=<?php echo $dong['id_dong']?>"><span><svg class="glyph stroked cancel" style="width: 20px;height: 20px;"><use xlink:href="#stroked-cancel"/></svg></span></a></td>
            </tr>
            <?php
        }
        ?>
