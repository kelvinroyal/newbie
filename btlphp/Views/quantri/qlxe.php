...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">           
                     ...
                     <nav class="navbar navbar-default">
                        <div class="container-fluid">
                           <ul class="nav navbar-nav">
                              ...
                              <li><a href="quantri.php?page_layout=addxe">Thêm xe</a></li>
                          </ul>
        ...
        <table class="table table-striped">
            <tr id="tbl-first-row">
              <td width="5%">#</td>
              <td width="25%">Tên xe</td>
              <td width="25%">Giá xe</td>
              <td width="25%">Hãng xe</td>
              <td width="25%">Hình xe</td>
              <td width="5%">Sửa</td>
              <td width="5%">Xóa</td>
          </tr>
          <?php
          while ($xe=$paginate->fetch_array()) {
              ?>
              <tr>
                <td><?php echo $xe['id_xe'];?></td>
                <td><?php echo $xe['name'];?></td>
                <td><?php echo $xe['price'];?></td>
                <td><?php echo $xe['name_dong'];?></td>
                <td><img style="width: 140px; height: 90px;" src="Views/images/<?php echo $xe['img'];?>" /></td>
                <td><a href="quantri.php?page_layout=editxe&id_xe=<?php echo $xe['id_xe']?>"><span><svg class="glyph stroked brush" style="width: 20px;height: 20px;"><use xlink:href="#stroked-brush"/></svg></span></a></td>
                <td><a onclick="return confirm('Bạn có chắc chắn muốn xóa hay không?')" href="quantri.php?page_layout=delxe&id_xe=<?php echo $xe['id_xe']?>"><span><svg class="glyph stroked cancel" style="width: 20px;height: 20px;"><use xlink:href="#stroked-cancel"/></svg></span></a></td>
            </tr>
            <?php
        }
        ?>
