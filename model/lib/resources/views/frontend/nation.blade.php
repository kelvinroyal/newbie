...
@section('main')
@section('title',$nation->name_nation.' Girl')
            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{asset('continent/'.$nation->continents->id_continents.'/'.strtolower($nation->continents->name_continents)).'.html'}}">{{$nation->continents->name_continents}}</a></li>
                        <li class="breadcrumb-item active" aria-current="page">{{$nation->name_nation}}</li>
                    </ol>
                </nav>
            </div>
        </div>
