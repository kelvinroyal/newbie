...
@section('title','Khóa luận hướng dẫn')
@section('title2','Thông tin khóa luận hướng dẫn')
@section('title3','Những khóa luận được hướng dẫn')
@section('main')
<div class="box box-info">
  <div class="box-header with-border">
    <h3 class="box-title">Khóa luận bạn hướng dẫn</h3>
  </div>
  <div class="box-body">
    @foreach($kl as $kls)
    <div class="col-md-6">
